import { mapGoogleCountryToRegistration } from "@/lib/google-country-codes";
...
export function parseGooglePlace(place: google.maps.places.PlaceResult): ParsedAddress | null {
  ...
  const countryIso2 = getComponent(components, "country", "short_name");
  ...
  return {
    ...
    state,
    postalCode,
    countryCode: countryIso2 ? mapGoogleCountryToRegistration(countryIso2) : "",
  };
}
