    ...
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-[100] md:hidden" role="dialog" aria-modal="true" aria-label="Site menu">
          <button
            type="button"
            className="absolute inset-0 bg-filler-ink/40 backdrop-blur-[2px]"
            aria-label="Close menu"
            onClick={close}
          />
          <div
            id={panelId}
            className="absolute inset-2 flex max-h-[calc(100dvh-1rem)] flex-col overflow-hidden rounded-2xl border border-filler-peach-200/90 bg-white shadow-2xl sm:inset-4 sm:max-h-[calc(100dvh-2rem)]"
          >
            <div className="flex items-center justify-between border-b border-filler-peach-200/80 px-4 py-3">
            ...
            <div className="grid min-h-0 flex-1 grid-cols-2 gap-0 divide-x divide-filler-peach-200/80">
              <nav className="min-h-0 overflow-y-auto px-3 py-4 text-sm" aria-label="Site pages">
              ...
              <nav className="min-h-0 overflow-y-auto px-3 py-4 text-sm" aria-label="Product categories">
                <p className="mb-2 text-[11px] font-semibold uppercase tracking-wide text-filler-ink/45">
                  Categories
                </p>
                <ul className="space-y-1">
            ...
            <div className="flex flex-wrap gap-2 border-t border-filler-peach-200/80 bg-filler-cream/50 px-4 py-3">
              <a
                href={SITE_PHONE_TEL}
                className="inline-flex flex-1 items-center justify-center gap-1 rounded-full border border-filler-peach-300 bg-white px-3 py-2 text-xs font-semibold text-filler-ink shadow-sm min-[380px]:flex-none"
              >
