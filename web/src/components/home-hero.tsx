...
import { HomeHeroFeatures } from "@/components/home-hero-features";
  ...
  const heroArtSrc =
    heroIllustrationSrc !== undefined
      ...
      : HOME_HERO_USE_CURATED
        ...
        : null;
  return (
    <section className="relative overflow-hidden bg-filler-cream sm:flex sm:min-h-[calc(100dvh-16rem)] sm:flex-col sm:justify-center">
      <div
      ...
      <div className="pointer-events-none absolute inset-0 hidden sm:block" aria-hidden>
        ...
        <div className="absolute right-0 top-44 h-40 w-72 rounded-[100%] bg-filler-coral-400/25 sm:right-2 sm:top-72 sm:h-44 sm:w-80 lg:right-4 lg:top-[22rem] lg:h-48 lg:w-96" />
      ...
      <div className="pointer-events-none absolute right-1 top-2 z-[5] w-[110px] sm:right-2 sm:top-4 sm:w-[160px] lg:right-4 lg:top-6 lg:w-[210px]">
        <div className="relative">
          <div className="absolute inset-0 top-2 scale-90 rounded-3xl bg-filler-pink-200/40 blur-xl sm:block" />
          {heroArtSrc ? (
            <Image
              src={heroArtSrc}
              alt=""
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 pt-36 pb-10 sm:px-6 sm:py-16">
        <div className="relative z-10 flex flex-col items-center justify-center text-center sm:translate-y-8">
