    ...
    <li>
      ...
      >
        <div className="relative flex min-h-[9.5rem] items-center justify-between rounded-2xl border border-zinc-200 bg-gradient-to-br from-zinc-50 to-white px-4 py-4">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-teal-200/90 bg-teal-50 text-2xl font-bold text-teal-800">
            {initial}
          </div>
        ...
        <div className="flex flex-1 flex-col px-2 pb-3 pt-4">
          <h2 className="line-clamp-2 text-lg font-bold tracking-tight text-zinc-900 transition group-hover:text-teal-900">
            {name}
          </h2>
          {description ? (
...
function FeaturedCategoryCard({ slug, name, description }: ShopCategoryRow) {
  ...
  return (
    <li className="md:col-span-2 lg:col-span-3">
      ...
      >
        <div className="relative flex h-48 w-full shrink-0 items-center justify-center rounded-2xl border border-zinc-200 bg-gradient-to-br from-teal-50 via-white to-zinc-50 md:h-auto md:min-h-full md:w-[min(34%,18rem)]">
          <div className="flex h-20 w-20 items-center justify-center rounded-3xl border border-teal-200/90 bg-white text-4xl font-bold text-teal-800 shadow-sm">
            {initial}
          </div>
        ...
        <div className="flex flex-1 flex-col justify-center gap-2 px-4 py-5 sm:px-6 sm:py-6 md:py-8 md:pl-8">
          <p className="text-xs font-medium uppercase tracking-[0.2em] text-teal-800/90">Featured</p>
          ...
          <span className="mt-1 inline-flex w-fit items-center gap-2 rounded-full border border-teal-200/80 bg-teal-50/90 px-4 py-2 text-sm font-semibold text-teal-900 shadow-sm backdrop-blur-sm transition group-hover:border-teal-300 group-hover:bg-teal-100">
...
export function ShopByCategoryHero() {
  return (
    <section className="relative overflow-hidden rounded-[1.75rem] bg-gradient-to-br from-slate-950 via-teal-900 to-cyan-950 px-6 py-10 text-white shadow-xl sm:px-10 sm:py-12">
      <div
        className="pointer-events-none absolute -right-24 -top-28 h-72 w-72 rounded-full bg-teal-400/20 blur-3xl"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute -bottom-20 -left-16 h-56 w-56 rounded-full bg-teal-300/15 blur-3xl"
        aria-hidden
      />
      <p className="relative text-xs font-medium uppercase tracking-[0.22em] text-teal-200/90 sm:text-sm">
        Browse catalog
      </p>
      <h1 className="relative mt-3 max-w-3xl text-3xl font-semibold leading-tight tracking-tight sm:text-4xl lg:text-[2.65rem]">
        Shop by category
      </h1>
      <p className="relative mt-4 max-w-2xl text-sm leading-relaxed text-teal-100/90 sm:text-base">
